...
<section class="as-section" id="about-section" aria-labelledby="as-heading" >
    ...
    <div class="as-overlay" aria-hidden="true" style="background-image: url('{{ asset('images/meeting-spaces.jpg') }}');background-repeat: no-repeat;
    ...
    <div class="container-xl as-inner">
        <div class="row align-items-center g-0">
            ...
            <div class="col-12 col-lg-5 as-left">
                ...
                <a href="{{ url('/about-us') }}" class="our-delivery-model-btn" aria-label="Learn more about us">
    Learn More About Us
                    ...
                    @foreach ($stats as $stat)
                        ...
                        >
                            ...
                            <div class="as-card__icon-row" aria-hidden="true">
                                @switch($stat['icon'])
                                    @case('globe')
                                       <svg class="as-icon" viewBox="0 0 24 24" fill="none"
