...
<style>
    ...
    .ir-card { background: #fff; border-radius: 6px; overflow: hidden; box-shadow: 0 2px 12px rgba(0,0,0,.08); display: flex; flex-direction: column; height: Auto; transition: transform .22s ease, box-shadow .22s ease; }
...
.ir-thumb img { width:100%; height:100%; object-fit:cover; display:block; transition: transform .35s ease; }
    ...
    /* Body with left border animation */
    .ir-body {
    ...
    /* Left border — grows top to bottom on card hover */
    .ir-body::before {
        content: '';
        position: absolute;
        left: 0;
    ...
    .ir-card:hover .ir-body::before {
        height: 100%;                    /* grows full height top → bottom */
    }
...
<section class="ir-section" aria-label="Insights and Resources">
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="/insights" class="ir-view-all">View All &rarr;</a>
        </div>
        ...
        <div class="row g-6">
            ...
            <div class="col-12 col-sm-6 col-lg-4">
                <article class="ir-card">
                    ...
                    <div class="ir-body">
                        <h3 class="ir-title">
                            <a href="/insights/9-steps-of-the-engineering-design-process">
            ...
            <div class="col-12 col-sm-6 col-lg-4">
                <article class="ir-card">
                    ...
                    <div class="ir-body">
                        <h3 class="ir-title">
                            <a href="/insights/7-stages-of-construction-a-complete-guide">
